...
from account.models import Pharmacy ,Customer
...
class Item(models.Model):
    ...
    like=models.ManyToManyField(Customer,blank=True,null=True)
...
class Doctor(models.Model):
    branch = models.ForeignKey(Pharmacy, on_delete=models.CASCADE,related_name='doctors')
    name=models.CharField(max_length=50)
